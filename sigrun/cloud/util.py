...
class CloudUtility:
    ...
    def get_vpc_id(self) -> str:
        vpcs = self.ec2_client.describe_vpcs(Filters=[{"Name": "tag:Name", "Values": ["SigrunAppStack/GameServerVpc"]}])
    ...
    def get_security_group_ids(self, vpc_id: str) -> List[str]:
        security_groups = self.ec2_client.describe_security_groups(Filters=[
